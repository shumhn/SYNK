        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            <button
              ...
              className="w-full rounded-lg border border-gray-700 text-gray-200 py-3 flex items-center justify-center gap-3 bg-neutral-900 hover:bg-neutral-800 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              <span className="text-sm">{googleLoading ? "Signing up..." : "Sign up with Google"}</span>
            </button>
          </div>
